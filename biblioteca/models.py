...
class Biblioteca(models.Model):
    ...
    bibcode = models.CharField(max_length=80, verbose_name="bibcode", blank=True)
    ...
    estudiantesEnArticulo = models.CharField(max_length=150,verbose_name="Estudiantes en el articulo", blank=True)
    revistaPublicacion = models.CharField(max_length=150,blank=True)
    paginas = models.CharField(max_length=150, blank=True)
    volumen = models.CharField(max_length=150, blank=True)
    url = models.CharField(max_length=550, blank=True)

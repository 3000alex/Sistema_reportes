...
class Modelo14(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    descripcion = models.TextField(max_length=15000, verbose_name="Descripcion", blank=True, default='')
    telescopio_instrumento_infra = models.CharField(max_length=500,verbose_name="Telescopio, instrumento, infraestructura", blank=True, choices=TelescopioChoise,default='')
    url = models.CharField(max_length=100,verbose_name="url", blank=True,default='')
    conferencia_proyecto = models.CharField(max_length=500,  verbose_name="Conferencia o proyecto", blank=True,default='')
    rol = models.CharField(max_length=500,  verbose_name="rol", blank=True,default='')
    fecha = models.CharField(max_length=200,  verbose_name="fecha", blank=True,default='')

...
class enviarReporte(View): 
    def get(self, request, *args, **kwargs):
        ...
        anexoModelo1 = Modelo1.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo2 = Modelo2.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo3 = Modelo3.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo4 = Modelo4.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo5 = Modelo5.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo6 = Modelo6.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo7 = Modelo7.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo8 = Modelo8.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo9 = Modelo9.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo10 = Modelo10.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo11 = Modelo11.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo12 = Modelo12.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo13 = Modelo13.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo14 = Modelo14.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo15 = Modelo15.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoModelo16 = Modelo16.objects.exclude(anexos = "", periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)
        anexoBiblioteca = Biblioteca.objects.exclude(anexos = "", fecha_ano=yearPeriodo).filter(usuario_id = request.user.id)
        anexoCitas = Citas.objects.exclude(anexos = "",periodo__fechaInicio__year = yearPeriodo).filter(usuario_id = request.user.id)

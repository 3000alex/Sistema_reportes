...
class Modelo1(models.Model):
    ...
    autores = models.TextField(max_length=15000,verbose_name="Nombre de los autores", blank=True,null=True)
...
class Modelo2(models.Model):
    ...
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombreProyecto = models.CharField(max_length=500,verbose_name="Nombre del proyecto",blank=True,null=True)
    descripcion = models.TextField(max_length=15000,verbose_name="descripcion",blank=True,null=True)
    participantes = models.TextField(max_length=500,verbose_name="participantes",blank=True,null=True)
    estudiantes = models.CharField(max_length=10000,verbose_name="estudiantes",blank=True,null=True)
    responsableTecParticipante = models.CharField(max_length=500,verbose_name="responsable,tecnico o participante", blank=True,null=True,choices=ResponsableSelect)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo3(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    tituloPresentacion = models.CharField(max_length=500,verbose_name="Titulo de la presentacion", blank=True,null=True)
    autores = models.TextField(max_length=15000,verbose_name="Nombre de los autores", blank=True,null=True)
    nombreConferencia = models.CharField(max_length=500,verbose_name="Nombre de la conferencia", blank=True,null=True)
    fecha = models.CharField(max_length=500,verbose_name="fecha", blank=True,null=True)
    presentacionPoster = models.CharField(max_length=500,verbose_name="Presentacion oral o poster",choices=Presentacionselect, blank=True,null=True)
    estudiantes = models.CharField(max_length=10000,verbose_name="Nombre de los estudiantes", blank=True,null=True)
    doi = models.CharField(max_length=500,verbose_name="DOI/ISBN", blank=True,null=True)
    url = models.CharField(max_length=500,verbose_name="Nombre de la url", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo4(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombreCompleto = models.CharField(max_length=500,verbose_name="Nombre completo", blank=True,null=True)
    tituloTesis = models.CharField(max_length=500,verbose_name="Titulo de tesis", blank=True,null=True)
    fecha = models.CharField(max_length=500,verbose_name="fecha", blank=True,null=True)
    url = models.CharField(max_length=500,verbose_name="link de la url", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo5(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombreCurso = models.CharField(max_length=500,verbose_name="Nombre del Curso", blank=True,null=True)
    periodoNumeral = models.CharField(max_length=500,verbose_name="Periodo del numeral", blank=True,null=True)
    notas = models.CharField(max_length=500,verbose_name="Notas", blank=True,null=True)
...
class Modelo6(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombre = models.CharField(max_length=500,verbose_name="Nombre", blank=True,null=True)
    tituloTesis = models.CharField(max_length=500,verbose_name="titulo de la tesis", blank=True,null=True)
    Grado = models.CharField(max_length=500,verbose_name="Tipo de grado", blank=True,null=True,choices=Gradoselect)
    institucion = models.CharField(max_length=500,verbose_name="Institucion", blank=True,null=True)
    fecha = models.CharField(max_length=500,verbose_name="fecha", blank=True,null=True)
    notas = models.CharField(max_length=500,verbose_name="notas", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/',null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo7(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    autores = models.TextField(max_length=15000,verbose_name="autores", blank=True,null=True)
    descripcion = models.TextField(max_length=15000,verbose_name="descripcion", blank=True,null=True)
...
class Modelo8(models.Model):
    ...
    descripcion = models.TextField(max_length=15000,verbose_name="descripcion", blank=True,null=True)
    participantes = models.TextField(max_length=500,verbose_name="participantes", blank=True,null=True)
    financiamiento = models.CharField(max_length=500,verbose_name="financiamiento", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/',null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo9(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    titulo = models.TextField(max_length=15000,verbose_name="titulo", blank=True,null=True)
    autores = models.TextField(max_length=15000,verbose_name="autores", blank=True,null=True)
    numeroReportes = models.CharField(max_length=500,verbose_name="numero de reportes", blank=True,null=True)
    fecha = models.CharField(max_length=500,verbose_name="fecha", blank=True,null=True)
    url = models.CharField(max_length=500,verbose_name="url", blank=True,null=True)
    doi = models.CharField(max_length=500,verbose_name="doi", blank=True,null=True)
    revistaPublicacion = models.CharField(max_length=500,verbose_name="revista o publicacion", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo10(models.Model):
    ...
    fecha = models.CharField(max_length=500,verbose_name="fecha", blank=True,null=True)
    url = models.CharField(max_length=500,verbose_name="url", blank=True,null=True)
    periodoNumeral = models.CharField(max_length=500,verbose_name="periodo", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/',null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo11(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombreEstudiante = models.CharField(max_length=500,verbose_name="Nombre del estudiante", blank=True,null=True)
    descripcion = models.TextField(max_length=15000,verbose_name="Descripcion", blank=True,null=True)
    fecha = models.CharField(max_length=500,verbose_name="Fecha", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo12(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    laboratorioTaller = models.CharField(max_length=500,verbose_name="Laboratorio o taller", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/',null=True)
...
class Modelo13(models.Model):
    ...
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    descripcion = models.TextField(max_length=15000,verbose_name="Descripcion", blank=True,null=True)
    agenciasFinancieras = models.CharField(max_length=500,verbose_name="Agencias Financieras", blank=True,null=True)
    anexos = models.FileField(verbose_name="archivo PDF", upload_to='anexos/', null=True)
    fechaCreacion = models.DateTimeField(auto_now_add=True, verbose_name="Fecha y Hora de creacion")
...
class Modelo16(models.Model):
    ...
    numeral = models.ForeignKey(Numeral, null=True,blank=True, on_delete=models.CASCADE)
    periodo = models.ForeignKey(Periodo, on_delete=models.CASCADE)
    nombreEstudiante = models.CharField(max_length=500,  verbose_name="Nombre de estudiantes", blank=True,null=True)
    coordinacion = models.CharField(max_length=500,  verbose_name="Coordinacion", blank=True,null=True)
